...
export default function Home() {
  ...
  return (
    <>
      <img className="homeBackground" src="/homeBackground.jpg" />
        ...
        <div className="introductionText">
          ...
          >
            <div>
              ...
              />
              <p style={{ fontSize: "18px", color: "black" }}>Equipment</p>
            </div>
            <div style={{ marginTop: "50px" }}>
              ...
              />
              <p style={{ fontSize: "18px", color: "black" }}>Supplements</p>
            </div>
            <div>
              <img
                height={60}
              ...
              />
              <p style={{ fontSize: "18px", color: "black" }}>Accessories</p>
            </div>
          </div>
